...
var hdelk = (function(){
    ...
    var node_highlight_fill_color = ['#FFF', '#DDD', '#4bF','#F88', '#FE6','#7e0', "#B5D"];
    ...
    var node_highlight_name_text_color = [ '#DDD', '#222', '#46C', '#922', '#A90', '#350', "#619" ];
    ...
    var port_highlight_fill_color = [ '#DDD', '#444', '#06d', '#C00', '#980', '#590', "#619" ];
    var port_spacing = 4;
